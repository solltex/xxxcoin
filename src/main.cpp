...
int64 nChainStartTime = 1398674861; //Wed, 16 Apr 2014 16:00:00 GMT
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1398674861; //Wed, 16 Apr 2014 16:00:00 GMT
      ...
      if (true  && (block.GetHash() != hashGenesisBlock)) {
        ...
        assert(block.hashMerkleRoot == uint256("0xb6121fe7bbdb174210d9abe12a8c8ac2e8d5d86d696642193e9dc19ee8ef49bc"));
